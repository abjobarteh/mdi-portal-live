<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-10 pe-5 pt-5 pb-2">
      <router-link to="#" class="d-flex align-center text-decoration-none">
        <v-img
          ...
          eager
          class="app-logo me-3"
          style="border-radius: 50%; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.2); transform: translateY(-2px)"
        ></v-img>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      ></nav-menu-link>
      <nav-menu-group
        v-if="currentUser && (currentUser.role_id == '2' || currentUser.role_id == '1')"
        title="Gradings"
